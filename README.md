...
- For more detail, please read the descriptions on top of each function, and run main.py. The output will show more deails, including accuracy, loss, and more graphs.
